...
class backWarp(nn.Module):
    ...
    def __init__(self, H, W):
        ...
        self.W = W
        self.H = H
        self.register_buffer('gridX', torch.tensor(
            gridX, requires_grad=False))
        self.register_buffer('gridY', torch.tensor(gridY, requires_grad=False))
